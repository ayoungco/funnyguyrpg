...
- [ ] Download EasyRPG Player web build and place files in web/ (see docs/next/00-web-release.md step 1)
- [ ] Convert Sound/*.wav to OGG to reduce download size (ffmpeg batch convert, see docs/next/00-web-release.md)
- [ ] Run scripts/build-web.sh and verify locally with python3 -m http.server 8080 --directory web/
- [ ] Set up Cloudflare Pages (or Netlify) deployment from this repo pointing at web/
